...
schema_view = get_swagger_view(title='DatJ API')
...
urlpatterns = [
    ...
    path('order/get-payment-service/', GetPaymentServiceAPIView.as_view()),
    path('order/get-ship-service/', GetShipServiceAPIView.as_view()),
